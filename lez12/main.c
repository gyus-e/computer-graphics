...
void display() {
  ...
  // glMap2d(GL_MAP2_VERTEX_3, u1, u2, 3, uorder, v1, v2, 12, vorder, &cp[0][0][0]);
  // glEnable(GL_MAP2_VERTEX_3);
  
  glMap2d(GL_MAP2_VERTEX_4, u1, u2, 4, uorder, v1, v2, 16, vorder, &cpw[0][0][0]);
